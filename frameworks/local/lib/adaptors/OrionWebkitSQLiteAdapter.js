/**
 * OrionWebkitSQLiteStorageAdapter
 *
 * Webkit SQLite storage implementation for Lawnchair (specific to Orion).
 *
 * Originally authored by ???.
 *
 * Significant portions rewritten by Sean Eidemiller (sean@halcyon.cc) to improve performance in
 * Chrome and Safari.
 */
var OrionWebkitSQLiteAdaptor = function(options) {
...
OrionWebkitSQLiteAdaptor.prototype = {
  ...
  save: function(obj, callback) {
    // TODO: [SE] Route to _saveAll if obj.key is an array of IDs.
    var that = this;
